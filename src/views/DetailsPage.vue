        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="about-right mb-90">
              ...
              <div class="about-prea">
                <p class="about-pera1 mb-25">
                  The refractor telescope uses a convex lens to focus the light
                  on the eyepiece. The reflector telescope has a concave lens
                  which means it bends in. It uses mirrors to focus the image
                ...
                <p class="about-pera1 mb-25">
                  ...
                  image that you eventually see. Collimation is a term fo Moms
                ...
                <p class="about-pera1 mb-25">
                  ...
                  telescope sits on. The mount is the actual tripod and the
                  wedge is the device that lets you attach the telescope to the
                  mount. Moms are like…buttons? Moms are like glue. Moms are
                  like pizza crusts. Moms are the ones who make sure things
              ...
              <div class="social-share pt-30">
                <div class="section-tittle">
                  <h3 class="mr-20">
                    <i class="fas fa-eye me-2"></i>{{ count }}
                  </h3>
            ...
            <div class="row">
              <div class="col-lg-8">
                ...
                <button
                  type="submit"
                  class="button button-contactForm boxed-btn mb-80"
